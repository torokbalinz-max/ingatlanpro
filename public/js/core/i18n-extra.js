...
// ---------- 2. kör: térkép oldal, helyválasztó, telek, statisztika, kezdőlap ----------
(() => {

    const EXTRA2 = {

        en: {
            locModeLabel: "Location type",
            locRadius: "Radius",
            locClickHint: "Click on the map",
            newHelyHelp2: "Click on the map where the property is. If you only know the area, choose approximate location.",
            telekJellegLabel: "Inside or outside town limits?",
            jelleg_belterulet: "Inside town limits (intravilan)",
            jelleg_kulterulet: "Outside town limits (extravilan)",
            field_telek_jelleg: "inside / outside town limits",
            reviewAllTypes: "All",
            importStepCity: "City",
            importStepType: "Property type",
            importStepLinks: "Links",
            importSaveWatch: "Save as watched",
            mapCountSuffix: "results on the map",
            mapNoLocCount: "{n} without location",
            viewMap: "Show on map",
            menuMapDesc: "Properties on the map",
            searchSzoba: "Rooms",
            searchEmelet: "Floor (0 = ground floor)",
            floorWordCap: "Floor",
            statsByTelepules: "By location",
            statsByJelleg: "Inside / outside town limits",
            statsCounted: "{n} of {db} listings counted (verified, with price and area)",
            statsMedianPrice: "Median price",
            statsAvgSub: "Average: {v}",
            statsMedianSub: "Median: {v}",
            statsTypicalSub: "Middle half of the prices",
            statsBestValue: "Lowest price per m² in this search",
            statsSubtitle: "Prices by district, condition, floor and rooms. Narrow it down with the filters on the left.",
            trendNote: "How the average price per m² changed over time.",
            homeTitle: "Find your next home in Transylvania.",
            homeSub: "Every listing of a city in one place, with real market prices and a quick valuation.",
            homeOnMap: "Browse on the map",
            homeBrowseTitle: "Browse by type",
            homeAllListings: "All listings",
            homeCatLakas: "Flats",
            homeCatHaz: "Houses",
            homeCatTelek: "Plots",
            homeCatUzlet: "Commercial spaces",
            homeCatCount: "{n} listings",
            homePhotoCredit: "Photos: Unsplash",
            homeFeatMapText: "All results on a map, with the same filters. Approximate locations are shown as circles.",
            homeFeatMapTitle: "Map",
            help_properties: [
                "Choose sale or rent and the property type at the top of the filters.",
                "For flats pick a district and a floor range (e.g. 1 to 1 = first floor only).",
                "Switch between cards and table, or open the map with the Show on map button."
            ]
        },

        hu: {
            locModeLabel: "A hely típusa",
            locRadius: "Sugár",
            locClickHint: "Kattints a térképre",
            newHelyHelp2: "Kattints a térképen az ingatlan helyére. Ha csak a környéket tudod, válaszd a közelítő helyet.",
            telekJellegLabel: "Belterület vagy külterület?",
            jelleg_belterulet: "Belterület (intravilan)",
            jelleg_kulterulet: "Külterület (extravilan)",
            field_telek_jelleg: "belterület / külterület",
            reviewAllTypes: "Mind",
            importStepCity: "Város",
            importStepType: "Milyen ingatlan?",
            importStepLinks: "Linkek",
            importSaveWatch: "Mentés figyeltként",
            mapCountSuffix: "találat a térképen",
            mapNoLocCount: "{n} hely nélkül",
            viewMap: "Megnézem térképen",
            menuMapDesc: "Az ingatlanok a térképen",
            searchSzoba: "Szobák",
            searchEmelet: "Emelet (0 = földszint)",
            floorWordCap: "Emelet",
            statsByTelepules: "Hely szerint",
            statsByJelleg: "Belterület / külterület",
            statsCounted: "{db} hirdetésből {n} számít bele (ellenőrzött, van ára és területe)",
            statsMedianPrice: "Medián ár",
            statsAvgSub: "Átlag: {v}",
            statsMedianSub: "Medián: {v}",
            statsTypicalSub: "Az árak középső fele",
            statsBestValue: "Legalacsonyabb négyzetméterár ebben a keresésben",
            statsSubtitle: "Árak kerület, állapot, emelet és szobaszám szerint. A bal oldali szűrőkkel szűkítheted.",
            trendNote: "Hogyan változott az átlagos négyzetméterár.",
            homeTitle: "Találd meg a következő otthonod Erdélyben.",
            homeSub: "Egy város összes hirdetése egy helyen, valós piaci árakkal és gyors értékbecsléssel.",
            homeOnMap: "Böngészés a térképen",
            homeBrowseTitle: "Böngéssz típus szerint",
            homeAllListings: "Összes hirdetés",
            homeCatLakas: "Lakások",
            homeCatHaz: "Családi házak",
            homeCatTelek: "Telkek",
            homeCatUzlet: "Üzlethelyiségek",
            homeCatCount: "{n} hirdetés",
            homePhotoCredit: "Fotók: Unsplash",
            homeFeatMapText: "Az összes találat a térképen, ugyanazokkal a szűrőkkel. A közelítő helyek körként látszanak.",
            homeFeatMapTitle: "Térkép",
            help_properties: [
                "A szűrők tetején válaszd ki: eladó vagy kiadó, és milyen típusú ingatlan.",
                "Lakásnál kerületet és emelet-tartományt is megadhatsz (pl. 1–1 = csak első emelet).",
                "Válthatsz kártyák és táblázat között, vagy a Megnézem térképen gombbal a térképre."
            ]
        },

        ro: {
            locModeLabel: "Tipul locației",
            locRadius: "Rază",
            locClickHint: "Dă click pe hartă",
            newHelyHelp2: "Dă click pe hartă unde se află proprietatea. Dacă știi doar zona, alege locația aproximativă.",
            telekJellegLabel: "Intravilan sau extravilan?",
            jelleg_belterulet: "Intravilan",
            jelleg_kulterulet: "Extravilan",
            field_telek_jelleg: "intravilan / extravilan",
            reviewAllTypes: "Toate",
            importStepCity: "Oraș",
            importStepType: "Tipul proprietății",
            importStepLinks: "Linkuri",
            importSaveWatch: "Salvează ca urmărit",
            mapCountSuffix: "rezultate pe hartă",
            mapNoLocCount: "{n} fără locație",
            viewMap: "Vezi pe hartă",
            menuMapDesc: "Proprietățile pe hartă",
            searchSzoba: "Camere",
            searchEmelet: "Etaj (0 = parter)",
            floorWordCap: "Etaj",
            statsByTelepules: "După localitate",
            statsByJelleg: "Intravilan / extravilan",
            statsCounted: "{n} din {db} anunțuri luate în calcul (verificate, cu preț și suprafață)",
            statsMedianPrice: "Preț median",
            statsAvgSub: "Medie: {v}",
            statsMedianSub: "Median: {v}",
            statsTypicalSub: "Jumătatea din mijloc a prețurilor",
            statsBestValue: "Cel mai mic preț pe m² din această căutare",
            statsSubtitle: "Prețuri pe cartier, stare, etaj și camere. Restrânge cu filtrele din stânga.",
            trendNote: "Cum s-a schimbat prețul mediu pe m².",
            homeTitle: "Găsește-ți următoarea casă în Transilvania.",
            homeSub: "Toate anunțurile unui oraș într-un singur loc, cu prețuri reale ale pieței și evaluare rapidă.",
            homeOnMap: "Caută pe hartă",
            homeBrowseTitle: "Caută după tip",
            homeAllListings: "Toate anunțurile",
            homeCatLakas: "Apartamente",
            homeCatHaz: "Case",
            homeCatTelek: "Terenuri",
            homeCatUzlet: "Spații comerciale",
            homeCatCount: "{n} anunțuri",
            homePhotoCredit: "Fotografii: Unsplash",
            homeFeatMapText: "Toate rezultatele pe hartă, cu aceleași filtre. Locațiile aproximative apar ca cercuri.",
            homeFeatMapTitle: "Hartă",
            help_properties: [
                "Sus în filtre alege vânzare sau închiriere și tipul proprietății.",
                "La apartamente poți alege cartierul și un interval de etaj (de ex. 1–1 = doar etajul 1).",
                "Poți comuta între carduri și tabel sau deschide harta cu butonul Vezi pe hartă."
            ]
        }

    };

    Object.keys(EXTRA2).forEach(nyelv => {
        I18N_STRINGS[nyelv] = Object.assign(I18N_STRINGS[nyelv] || {}, EXTRA2[nyelv]);
    });
